...
_DESCRIPTION = (
    ...
    "validations in the arm and a deflated Sharpe probability of at least 0.5 for "
    "the nominee's neutralized information ratio, trials counted over every "
    "revision the arm has validated on any span. A nomination that fails the gate "
