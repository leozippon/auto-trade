...
CANDIDATES = {
    "s_lq": "lowvol",    # main candidate: ivol60 ranks, screened construction
    "c_v15": "lowvol",   # control: the same ranks, unshaped
    "c_qual": "cfq",     # control: the same construction with the ivol60 rank removed
