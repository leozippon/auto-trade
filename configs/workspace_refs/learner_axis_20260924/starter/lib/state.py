...
control must count refits on exactly the same schedule. Which legs continue at
all is `primary.warm`: the DoubleEnsemble legs and `c_cold` are cold on every
refit, the others follow this cadence.
