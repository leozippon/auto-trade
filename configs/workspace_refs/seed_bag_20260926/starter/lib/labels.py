...
Horizon N = `knobs.HORIZON`. The window runs from the open of t+1 to the open
of t+1+N; the book itself sells at 09:30 and buys at the 15:00 close of t+1.
...
This label is the carrier's and every leg and every seed trains on it; the
arm moves only the training seed.
"""
