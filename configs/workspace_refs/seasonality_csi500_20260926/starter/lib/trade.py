...
section, lost its score or its bar -- then holdings ranked at or beyond
SEATS * KEEP_BAND; no swap cap. With KEEP_BAND 1.0 the book is re-ranked whole:
this score uses different lag months every month, so last month's rank carries
no information about this month's.
