...
158 columns, because the only thing this arm moves is the construction. The one
column read beyond the operators is `circ_mv`, which only the exposure
pull-back (`lib/book.py`) consumes.
