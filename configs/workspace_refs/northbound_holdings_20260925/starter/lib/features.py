"""Alpha158 feature block (158 operators) - formulas follow Microsoft Qlib's public Alpha158 set.
...
window d in {5,10,20,30,60}). Qlib does not fix a canonical column order; this one
is the lineage's, unchanged, so `c_base` here is the same book as in its sibling packs.
"""
