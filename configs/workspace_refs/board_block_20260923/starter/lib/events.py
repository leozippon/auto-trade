...
Pushing `ts_code` down matters more here than anywhere else: the board and
flow tables are whole-market, and the constituent union is an order of
magnitude smaller. A read without it pulls millions of rows into a 16 GiB
