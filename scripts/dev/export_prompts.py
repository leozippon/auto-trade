...
def render() -> str:
    ...
    parts = [
        ...
        "### 1.10 预算与事实",
        "",
        _block(FOLD_FACTS_SECTION),
        "",
        "### 1.11 反馈通道",
        "",
        _block(FOLD_FEEDBACK_SECTION),
        "",
        "### 1.12 Step 产物树",
        "",
        ...
        "",
        _block(subagent_system_prompt("fold", "developer")),
        "",
        "### 5.2 Fold auditor",
        "",
        "`subagent_system_prompt('fold', 'auditor')`：",
        "",
        _block(subagent_system_prompt("fold", "auditor")),
        "",
        ...
        "",
        _block(subagent_system_prompt("fold", "general-purpose")),
        "",
        "`subagent_system_prompt('fold', 'Explore')`：",
        "",
        _block(subagent_system_prompt("fold", "Explore")),
        "",
        "### 5.4 Meta 子角色",
        "",
        "`subagent_system_prompt('meta', 'auditor')`：",
        "",
        _block(subagent_system_prompt("meta", "auditor")),
        "",
